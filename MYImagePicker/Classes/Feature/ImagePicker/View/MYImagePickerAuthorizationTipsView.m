...
{
    if (_tipsLabel == nil) {
        CGRect frame = CGRectMake(8, 120, self.myp_width - 16, 60);
        ...
        [_tipsLabel setTextColor:MYHexColor(0x999999)];
...
- (UIButton *)settingButton
{
    if (_settingButton == nil) {
        CGRect frame = CGRectMake(0, 180, self.myp_width, 44);
        ...
        [_settingButton setTitleColor:MYHexColor(0xfe5353) forState:UIControlStateNormal];
...
- (void)setupUI
{
    ...
    [self setBackgroundColor:MYHexColor(0xffffff)];
}
